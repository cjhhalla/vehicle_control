...
import numpy as np
import rospy
from utils.utils import letterbox, split_for_trace_model, non_max_suppression, lane_line_mask

class YOLOPv2:
    def __init__(self, weights='/home/inha/casey_ws/src/Lane-Detect/data/weights/yolopv2.pt', device='cuda:0'):
